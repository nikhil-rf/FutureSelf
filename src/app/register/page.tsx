            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-background via-violet-start/5 to-background items-center justify-center p-12">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-lg">
                        Create an account and start sending messages to your future self.
                    </p>
                </motion.div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                ...
                >
                    ...
                    <p className="text-center text-sm text-muted-foreground mt-6">
                        ...
                        <Link href="/login" className="text-primary hover:text-violet-end transition-colors font-medium">
                            Sign in
                        </Link>
                    </p>
                </motion.div>
